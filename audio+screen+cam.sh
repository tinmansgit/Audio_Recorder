...
# logging
debug_log="/home/coder/bin/Bash/Audio+Screen+Cam/audio+screen+cam_debug.log"
error_log="/home/coder/bin/Bash/Audio+Screen+Cam/audio+screen+cam_error.log"
...
OUTPUT_DIR="/media/coder/460GB/Audio+Screen+Cam-Notes"
FILE_PREFIX="A+S+C_Note-"

# record function
record() {
	# set path and filename for Cam, Screen, Audio files
